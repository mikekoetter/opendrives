class Resource < MailForm::Base
  ...
  def faqs
    [
      ...
      ["How many clients can I connect to my OpenDrives system?", "There’s no limit to the number of clients, just keep in mind you’ll want to make sure you have enough performance resources to support your clients’ work ow. It’s cool though- OpenDrives will help you design your system to meet your needs!"],
      ["What kind of clients can I connect?", "Open Drives is compatible with pretty much any client platform that implements NFS and SMB according to the interoperable standard. Some (I’m looking at you, MacOS X 10.7!) aren’t good network citizens, so we recommend staying far away from them. Here is a list of client platforms we frequently work with:
        ...
        "],
      ["My storage system is full, what do I do?", "We recommending archiving  les you don’t need instant access for anymore. This allows you to keep your active storage focused on active projects, and your active-archive storage (yes, that’s a thing) o ers you both lower cost and a place to backup both your current and older (less used)  les. If you can’t do that, contact sales@opendrives.com to see about zero-downtime expansion of your OpenDrives system. (sorry, that was sales-y)."],
      ...
      ["How can I see how much bandwidth my system is using?", "Login to the OPUS UI by pointing your browser at http://your-storage-ip/ and authenticating. The home screen will show you utilization, network tra c, and storage bandwidth performance."],
      [ "I can’t remember the login information or it’s not working. What do I do?",  "Login to the OPUS UI by pointing your browser at http://your-storage-ip/ and authenticating. The home screen will show you utilization, network tra c, and storage bandwidth performance."],
      [ "I can’t remember the login information or it’s not working. What do I do?", "Login to the OPUS UI by pointing your browser at http://your-storage-ip/ and authenticating. The home screen will show you utilization, network tra c, and storage bandwidth performance."],
      ["Am I running the latest version of my software?", "TRY AGAIN WITH THE CAPS LOCKS OFF. Oops. If that doesn’t work hit us up at support@opendrives.com and we’ll reset it for you."],
      ["How do I update my OpenDrives system?", "Probably, but drop us a line at support@opendrives.com and we’ll make sure."],
      [ "How do I contact OpenDrives support?", "Currently, this is something we do with you. Contact us at support@opendrives.com and we’ll schedule a time that’s convenient for you."],
      ["How do I contact OpenDrives support?", "Email (support@opendrives.com) and telephone (888-778-5491) are the best ways."],
      ...
      ["What are the di erences between your product models?", "Please refer to the OpenDrives one sheet for quick reference di erentiation between the product lines."],
      ["My support is close to expiring, how do I renew?", "Your account representative can make all of the arrangements. If you haven’t already been contacted, please contact them or sales@opendrives.com to inquire about support renewals."]
    ]
  end
