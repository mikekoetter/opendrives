...
$(document).ready(function() {
	...
	if ($(window).width() > 767) {
		var homeScene3 = new ScrollMagic.Scene({triggerElement: "#home-section-4-5", offset: -80})
	...
	var caseInteriorScene7 = new ScrollMagic.Scene({triggerElement: ".case-interior-section3", offset: -100})
